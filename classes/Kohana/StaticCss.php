...
class Kohana_StaticCss extends StaticFile
{
                ...
                if ( ! empty($matches[1])) {
                    foreach ($matches[1] as $css) {
                        if ($i > 20) {
                            ...
                            throw new Kohana_Exception('Can\'t read css file: :css_filename.',
                                [':css_filename' => $dir . $css],
                                Kohana_Exception::$php_errors[E_ERROR]
                            );
                        }
                    }
                }
    ...
    {
        return $this->_removePath('_css', $href, $condition);
    }
